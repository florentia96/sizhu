...
export const DAY_LORD: Record<string, DayLordEntry> = {
  ...
  "พุธ": { lord: "พระพุธ", tr: "พูดเก่ง เจรจาดี มีเสน่ห์ ปรับตัวไว ฉลาดเฉลียว", color: ["เขียว", "เขียวขี้ม้า"], avoid: ["ชมพู", "แดง"], work: ["ส้ม", "ทอง"], money: ["ดำ", "เทา"], love: ["เหลือง"], luck: ["เขียว", "ทอง"] },
  ...
  "เสาร์": { lord: "พระเสาร์", tr: "หนักแน่น อดทน เก็บตัว จริงจัง รับผิดชอบสูง", color: ["ดำ", "ม่วง", "เทา"], avoid: ["เขียว", "เขียวขี้ม้า"], work: ["ฟ้า", "น้ำเงิน"], money: ["เขียว"], love: ["ขาว", "ครีม"], luck: ["ดำ", "ม่วง"] },
  // Rahu = ruler of Wednesday night (born 18:00-05:59); colors per the Wednesday-night belief: auspicious dark/gray-black tones - kalakini = Jupiter colors (orange/yellow)
  // Sources: komchadluek.net/horoscope/fortune/604327, sanook.com/horoscope/295007
  "ราหู": { lord: "พระราหู (พุธกลางคืน)", tr: "ลึกลับ มีเสน่ห์เฉพาะตัว กล้าได้กล้าเสีย ไหวพริบดี พลิกสถานการณ์เก่ง", color: ["เทา", "ดำ", "เทาเข้ม"], avoid: ["ส้ม", "เหลือง"], work: ["แดง"], money: ["แดง", "ม่วง"], love: ["ชมพู", "แดง"], luck: ["เทา", "ม่วง"] },
};
...
export const LIFEPATH: Record<number, { k: string; d: string }> = {
  ...
  11: { k: "เลขพลังพิเศษ — ผู้จุดประกาย", d: "สังหรณ์แรง มีพลังบันดาลใจผู้อื่น ไวต่อความรู้สึก ควรจัดการความเครียดให้ดี" },
  22: { k: "เลขพลังพิเศษ — นักสร้างยิ่งใหญ่", d: "วิสัยทัศน์กว้าง เปลี่ยนความฝันเป็นจริงได้ มีศักยภาพสูง แต่กดดันตัวเองง่าย" },
};
