...
export const DAY_LORD: Record<string, DayLordEntry> = {
  ...
  // ราหู = ผู้ครองวันพุธกลางคืน (เกิด 18:00–05:59) สีตามคติพุธกลางคืน: มงคลโทนมืด/เทาดำ · กาลกิณี=สีพฤหัส (ส้ม/เหลือง)
  // ที่มา: komchadluek.net/horoscope/fortune/604327, sanook.com/horoscope/295007
