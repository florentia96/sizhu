...
export function rasiReport(y: number, m: number, d: number): Section[] {
  ...
  const grid: Section = {
    ...
    glyph: "星",
    cells: [
      { name: "ราศี", value: "ราศี" + r.s, note: "ตามราศีจักรแบบไทย" },
      {
        name: "ธาตุประจำราศี",
        value: r.el,
  ...
  return [
    ...
    },
    {
      kind: "note",
      text:
        "อิงราศีจักรแบบไทย (แบบนิรายนะ อิงดาวจริง) ที่คำนวณจากตำแหน่งดาวจริง ช่วงวันจึงต่างจากราศีสากลที่อิงฤดูกาล",
    },
    {
      kind: "note",
      text:
        "ช่วงวันในตารางเป็นค่าโดยประมาณ อาจคลาดเคลื่อนได้ราว ±1 วันในแต่ละปี ให้ยึดช่อง “ราศีตามดาวจริง” เป็นคำตอบที่แม่นยำที่สุด ส่วนดาวเจ้าเรือนและความเข้ากันของธาตุอ้างอิงหลักโหราศาสตร์สากล",
    },
  ];
}
