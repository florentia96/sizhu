...
export const natalEngine: FeatureEngine = {
  build(vals: string[]): Section[] {
    ...
    secs.push({
      kind: "note",
      text: "คำนวณจากตำแหน่งดาวจริงด้วยปฏิทินดาราศาสตร์ แบบ tropical zodiac (จักรราศีอิงฤดูกาล) และระบบเรือน Placidus ราศีในดวงนี้จึงเป็นระบบสากล อาจต่างจากราศีแบบไทย (นิรายนะ อิงดาวจริง) ในเมนูราศีเกิดราวหนึ่งราศี เวลาเกิดที่คลาดเคลื่อนแม้เพียงไม่กี่นาทีมีผลต่อลัคนา จุดกลางฟ้า และตำแหน่งเรือนได้ ระบบใช้เขตเวลามาตรฐานของเมือง ยังไม่รวมการปรับเวลาออมแสง (DST) หรือเขตเวลาในอดีต",
    });
    return secs;
  },
};
