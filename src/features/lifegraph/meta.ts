...
export const lifeMeta: FeatureMeta = {
  ...
  long: "อ่านจังหวะชีวิตช่วงหนึ่งจากดาวจร (transit) จริงที่ทำมุมกับดาวในดวงกำเนิด ผสานกับชั้นเลขศาสตร์ (Life Path และ Personal Year) ระบุ 'ช่วงที่อยากเน้น' เพื่อกรองดาวให้ตรงเรื่อง และเลือก 'ณ วันที่' ที่ต้องการดูจังหวะ",
};
